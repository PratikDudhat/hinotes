            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Challanges List</strong>
                        @can('challanges-create')
                        <div class="pull-right">
                            <a class="btn btn-success" href="{{ route('challanges.create') }}"> Create New Challanges</a>
                        </div>
                         @endcan
                    </div>
...
<div id="datatablelink" style="display: none;">{{ route('challangesfilter') }}</div>
