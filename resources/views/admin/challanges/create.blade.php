            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Create New Challanges</strong>
                        <div class="pull-right">
                            <a class="btn btn-primary" href="{{ route('challanges.index') }}"> Back</a>
                        </div>
                    </div>
                    <div class="card-body">
                    {!! Form::open(array('route' => 'challanges.store','method'=>'POST','enctypt'=>'multipart/form-data','files'=> true,'autocomplete'=>'off')) !!}
                    <div class="row">
