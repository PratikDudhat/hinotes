...
class AuthController extends ResponseController
{
    ...
    {
        $this->middleware('auth:api', ['except' => ['login', 'create', 'forgotPassword', 'doResetPassword', 'doVerifyEmail','social_login']]);
        $this->guard = "api";
    }
	...
	public function create(Request $request)
    {
		...
		$success = [
			...
			'message' => "Verification cods has been sent successfully to ".$request->get('email'),
			'success' => true,
            'data' => $user,			
		];
		return $this->sendResponse($success);
    ...
    public function forgotPassword(Request $request)
    {
        ...
        $success = [
            'message' => "Password recovery code has been send successfully to {email}.",
			'success' => true,	
        ];
        return $this->sendResponse($success);
